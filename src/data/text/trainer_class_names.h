//
// DO NOT MODIFY THIS FILE! It is auto-generated from src/data/text/trainers_names.json and Inja template src/data/text/trainers_names_french.json.txt
//


const u8 gTrainerClassNames[][13] = {
    [TRAINER_CLASS_NONE] = _("{PKMN} TRAINER"),
        [TRAINER_CLASS_NONE] = _("Dresseur {PKMN}"),
        [TRAINER_CLASS_PKMN_TRAINER_UNUSED] = _("Dresseur {PKMN}"),
        [TRAINER_CLASS_AQUA_LEADER] = _("Boss Aqua"),
        ...
        [TRAINER_CLASS_RS_ELITE_FOUR] = _("Conseil des 4"),
